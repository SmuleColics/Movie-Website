    ...
    <main>
              ...
              <div class="wallpaper-description text-primary">
                ...
                <div class="wallpaper-left text-white d-flex flex-column">
                  ...
                  <div class="rating-text">
                    <p>Stephen Colbert brings his signature satire and comedy to The Late Show with Stephen Colbert, the #1 show in late night, where he talks with an...</p>
                  </div>
                </div>
              ...
              <div class="wallpaper-description text-primary">
                ...
                <div class="wallpaper-left text-white d-flex flex-column">
                  ...
                  <div class="rating-text d-block">
                    A heroic true story of Major Mukund Varadarajan, an Indian Army officer who displayed extraordinary bravery during a counterterrorism mission in
                  </div>
                </div>
            ...
            <div class="carousel-item">
              ...
              <div class="wallpaper-description text-primary">
                ...
                <div class="wallpaper-left text-white d-flex flex-column">
                  ...
                  <div class="rating-text d-block">
                    When his brother is killed, LAPD officer Mark leaves the city to return to the island he grew up on. Seeking answers and ultimately vengeance, he...
                  </div>
                </div>
      ...
      <section id="section-popular-documentaries-movies" class="section-trending ms-md-5 ms-3">
        <div id="dropdown-poular-documentaries" class="trending-this-week d-flex justify-content-between">
          <p class="trending-text text-white fs-24 fw-bold">Sci-Fi & Fantasy</p>
        </div>
        ...
        <div>
          ...
          <div class="wallpaper-description-tem d-flex flex-column justify-content-end align-items-end position-relative me-5">
              ...
              <div class="rating-text-tem my-4 position-relative text-white">
                <p>A successful man at a publishing company tries to rekindle his romance with an ex-girlfriend as those around him also search for love amidst conflict.</p>
              </div>
