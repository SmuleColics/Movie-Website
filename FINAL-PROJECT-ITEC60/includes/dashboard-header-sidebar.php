      ...
      <div class="container-fluid">
        <header class="d-flex align-items-center justify-content-between px-3 w-100">
          ...
          <div class="left-header d-flex align-items-center">
            <button class="navbar-toggler d-lg-none me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#dashboard-offcanvas" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
              <span class="navbar-toggler-icon"></span>
            </button>
            <a href="#">
              <img class="me-2" src="../MOVIE-IMG/HEADER-IMG/CINEVAULT-LOGO.svg" alt="CineVault Logo" style="width: 36px;">
            </a>
          ...
          <div class="right-header text-light d-flex align-items-center gap-1 gap-md-2">
            ...
            <div class="search-container position-relative">
              ...
              <input id="dashboard-search" type="text" class="form-control bg-transparent border-color text-light" placeholder="Search">
            </div>
            
            <!-- ========== NOTIFICATIONS ========== -->
            <div class="d-flex dropdown-center">
              <div id="bell-container">
                <button class="btn border-0 p-0 flexbox-align" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <div id="button-bell" class="position-relative flexbox-align"  
                    data-bs-toggle="tooltip" 
                    data-bs-placement="bottom" 
                    data-bs-title="See Profile Menu" 
            ...
            <div class="dropdown-center"> 
              ...
              <button class="btn p-0 border-0" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="rounded-pill dashboard-pfp" src="../MOVIE-IMG/HEADER-IMG/bert-pfp.jpg" alt="dashboard pfp" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="See Profile Menu">
              </button>
              ...
              <ul class="dropdown-menu dropdown-menu-dark mt-1 profile-dropdown" style="transform: translateX(-130px);">
                <li class="dropdown-profile-top d-flex mb-1">
                  <a class="dropdown-item d-flex align-items-center" href="#">
                    <div class="">
                      <img class="rounded-pill dashboard-dropdown-pfp me-2" src="../MOVIE-IMG/HEADER-IMG/bert-pfp.jpg" alt="dashboard pfp">
                    </div>
  
                    <div class="dropdown-profile-text">
                      <p class="fs-18 view-profile-text">View Profile</p>
                      <p class="m-0 fs-14 db-text-secondary">Soyvasoy</p>
                    </div>
                  </a>
                </li>
                <li class="mb-1">
        ...
        <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="dashboard-offcanvas" aria-labelledby="offcanvasDarkNavbarLabel"  style="background-color: #181818">
          ...
          <div class="offcanvas-body" style="background-color: #181818">
            <ul class="offcanvas-content list-unstyled fs-20" >
              ...
              <li class="sidebar-content-item sidebar-collapse d-flex align-items-cente justify-content-between mb-1" data-bs-toggle="collapse"  data-bs-target="#collapseAccount"  aria-expanded="true">
              ...
              <li class="sidebar-content-item sidebar-collapse d-flex align-items-center justify-content-between mb-1" data-bs-toggle="collapse"  data-bs-target="#collapseMovies" aria-expanded="true">
                <div class="d-flex align-items-center">
                  <span class="aside-icon material-symbols-outlined">
                    movie_edit
                  </span>
              ...
              <ul class="collapse list-unstyled show" id="collapseMovies">
                <?php 
                  $genres = ["Action","Adventure","Animation","Comedy","Crime","Documentary","Drama","Family","Fantasy","History","Terror","Music","Mistery","Science fiction","Cinema TV","Thriller","War","Western","Action & Adventure","Kids","News","Reality","Sci-Fi & Fantasy","Soap","Talk","War & Politics"];
    ...
    <aside class="sidebar" style="background-color: #181818;">
      <div class="sidebar-container text-light">
        ...
        <ul class="sidebar-content list-unstyled fs-20" >
          ...
          <li class="sidebar-content-item sidebar-collapse d-flex align-items-cente justify-content-between mb-1" data-bs-toggle="collapse"  data-bs-target="#collapseAccount">
            <div class="d-flex align-items-center">
              <span class="aside-icon material-symbols-outlined">
                manage_accounts
              </span>
          ...
          <li class="sidebar-content-item sidebar-collapse d-flex align-items-cente justify-content-between mb-1" data-bs-toggle="collapse"  data-bs-target="#collapseMovies">
            <div class="d-flex align-items-center">
              <span class="aside-icon material-symbols-outlined">
                movie_edit
              </span>
