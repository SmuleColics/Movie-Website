...
<body>
  ...
  <main class="container-lg p-0 overflow-hidden">
    <a href="add-trending.php" class="btn db-bg-primary text-white ms-3 mt-3">Add a Trending</a>
                ...
                <?php 
                  ...
                  while ($row = mysqli_fetch_assoc($select_query))  {
                    ...
                    <tr>
                      ...
                      <td>
                        <a href='edit-trending.php?id=$trending_id' class='db-text-primary'>
      ...
      <div class="modal-content">
        <form action="" method="post">
          <div class="modal-header">
            <h1 class="modal-title fs-5 db-text-sec">Delete Trending</h1>
