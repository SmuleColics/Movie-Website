...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($valid_poster && $valid_modal_poster && $valid_modal_poster_title && $valid_date_released && $valid_age_rating && $valid_description && $valid_age_rating_age && $valid_date_released_time && $valid_title) {
      // If all fields are valid, proceed with inserting the data into the database
      $title = $_POST['title'];
      ...
      $insert_query = mysqli_query($con, "INSERT INTO tbl_trending 
        (title, poster, modal_poster, modal_poster_title, date_released, age_rating, category, genre_1, genre_2, genre_3, description) 
        VALUES(
          '$title',
          '$file_poster', 
          '$file_modal_poster', 
      ...
      if (!$insert_query) {
          die(mysqli_error($con));  // Use $con instead of $insert_query
      } else {
        echo "<script>
        alert('Data Uploaded Successfully');
        window.location.href='db-add-landingpage.php';
        </script>";
        exit();
      }
  } else {
      // If validation fails, delete uploaded files
      if (file_exists($file_poster_path)) {
          unlink($file_poster_path);
      }
      if (file_exists($file_modal_poster_path)) {
          unlink($file_modal_poster_path);
      }
      if (file_exists($file_modal_poster_title_path)) {
...
<body>
  ...
  <main class="container-lg p-0 overflow-hidden">
    <a href="db-landingpage.php" class="btn db-bg-primary text-white ms-3 mt-3"><i class="fa-solid fa-chevron-left"></i>
    Go Back</a>
      ...
      <div class="card bg-dark">
        <div class="card-body">
          ...
          <div class="table-task-top db-text-sec">
            <div class="py-2 ps-3">
              <p class="m-0 fs-20">Add a Trending this week</p>
              <p class="m-0 fs-14" style="transform: translateY(-2px)">Add your movies/series to the CineVault database here</p>
            </div>
          </div>
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-2">
              <div class="col">
                ...
                <input type="text" name="title" id="title" class="form-control file-trending" placeholder="Title">
                <p class="fs-12 text-danger mt-1 mb-2">
                  <?php 
                  if (!$valid_title) {
              ...
              <div class="col">
                ...
                <input type="number" name="date-released" id="date-released" class="form-control file-trending" placeholder="0">
                <p class="fs-12 text-danger mt-1 mb-2">
                  <?php 
              ...
              <div class="col">
                ...
                <input type="number" name="age-rating" id="age-rating" class="form-control file-trending" placeholder="0">
                <p class="fs-12 text-danger mt-1 mb-2">
                  <?php 
                    if (!$valid_age_rating) {
              ...
              <div class="col">
                ...
                <div class="category-container">
                  <select name="category" id="category" class="form-control">
                    <option value="Movie" class="file-trending">Movie</option>
                    <option value="Series" class="file-trending">Series</option>
                  </select>
                </div>
            ...
            <div class="row mb-2">
                ...
                <div class="genre-container">
                  <select name="first-genre" id="first-genre" class="form-control">
                    <?php foreach ($genres as $genre): ?>
                      <option value="<?= htmlspecialchars($genre) ?>" class="file-trending"><?= htmlspecialchars($genre) ?></option>
                    <?php endforeach; ?>
                  </select>
              ...
              <div class="col-12 mt-3">
                ...
                <textarea name="description" id="description" class="form-control file-trending p-2" placeholder="The movie is about..."></textarea>
                <p class="fs-12 text-danger mt-1 mb-2">
                  <?php 
            ...
            <div class="d-flex justify-content-end mb-3">
              <button type="submit" name="add-trending-btn" class="btn db-bg-primary text-white ms-3 mt-3">Add Trending</button>
            </div>
