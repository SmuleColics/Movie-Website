...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($valid_date_released && $valid_age_rating && $valid_description && $valid_age_rating_age && $valid_date_released_time && $valid_title) {
        ...
        <div class="card-body">
          ...
          <div class="table-task-top db-text-sec">
            <div class="py-2 ps-3">
              ...
              <p class="m-0 fs-14" style="transform: translateY(-2px)">Edit your movies/series to the CineVault database here</p>
            </div>
          </div>
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-2">
              <div class="col">
                ...
                <input type="text" name="title" id="title" class="form-control file-trending" placeholder="Title" value="<?= $row['title'] ?>">
                <p class="fs-12 text-danger mt-1 mb-2">
                  <?php 
                  if (!$valid_title) {
