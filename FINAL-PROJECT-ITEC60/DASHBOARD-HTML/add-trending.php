...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($valid_poster && $valid_modal_poster && $valid_modal_poster_title && $valid_date_released && $valid_age_rating && $valid_description && $valid_age_rating_age && $valid_date_released_time) {
      ...
      $insert_query = mysqli_query($con, "INSERT INTO tbl_trending 
        (poster, modal_poster, modal_poster_title, date_released, age_rating, category, genre_1, genre_2, genre_3, description) 
        VALUES(
          '$file_poster', 
          '$file_modal_poster', 
      ...
      if (!$insert_query) {
        ...
        window.location.href='add-trending.php';
        </script>";
        exit();
      }
  } else {
